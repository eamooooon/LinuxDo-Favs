...
(function() {
    ...
    function deleteSelectedPanelFavorites() {
    ...
    function updatePostBtnState(btn, postId) {
        ...
        const favorites = getFavorites();
        const bookmarkId = `${topicId}_${topicId}`;
        const hasFav = Boolean(favorites[uniqueId] || favorites[bookmarkId]);
        const icon = hasFav ? '★' : '☆';
